...
# -------- 2. Feature list --------
sparse_features = []
dense_features = [col for col in data.columns if col not in ['SourceIP', 'DestinationIP', 'TimeStamp', 'Label', 'DestinationPort', 'SourcePort']]
...
# -------- 9. Save model --------
model.save("doh_deepfm_model", save_format="tf")