...
def extract_tls_flow_features(pcap_file):
    ...
    for (src_ip, dst_ip, src_port, dst_port), packets in flows.items():
        ...
        flow_data.append({
            ...
            "ResponseTimeTimeVariance": var_resp,
            "ResponseTimeTimeStandardDeviation": std_resp,
            "ResponseTimeTimeMean": mean_resp,
            "ResponseTimeTimeMedian": median_resp,
            "ResponseTimeTimeMode": mode_resp,
            "ResponseTimeTimeSkewFromMedian": skew_median_resp,
            "ResponseTimeTimeSkewFromMode": skew_mode_resp,
...
def doh_extraction(pcap_path):
    df = extract_tls_flow_features(pcap_path)
